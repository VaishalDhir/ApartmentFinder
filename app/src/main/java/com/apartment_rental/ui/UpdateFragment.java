...
public class UpdateFragment extends Fragment implements LocationListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String Facility = bundle.getString("facility");
        String Address = bundle.getString("address");
        String Size=bundle.getString("size");
        int Rent=bundle.getInt("rent");
         ApartmentId=bundle.getInt("aid");
        img1=bundle.getByteArray("img1");
        img2=bundle.getByteArray("img2");
        img3=bundle.getByteArray("img3");
        ...
        apartmentRent_ed.setText(String.valueOf(Rent));
        apartmentSize_ed.setText(Size);
        apartmentFacilty_ed.setText(Facility);
        apartment_img1.setImageBitmap(getImage(img1));
        apartment_img2.setImageBitmap(getImage(img2));
        apartment_img3.setImageBitmap(getImage(img3));
    ...
    private void AddProperty(String apartType, String apartAddress, String rent, String size, String apartDesc_ed, String facility, String rtype) {
        ...
        try {
            Call<AddApartment> call = userServices.UpdateProperty(ApartmentId,apartAddress, apartType,
                    rent, size, facility, apartDesc_ed, rtype, img1, img2, img3, lat, lang);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == 1) {
                ...
                if (flag == 1) {
                    img1 = getBytesFromBitmap(photo);
                    apartment_img1.setImageBitmap(photo);
                } else if (flag == 2) {
                    img2 = getBytesFromBitmap(photo);
                    apartment_img2.setImageBitmap(photo);

                } else {
                    img3 = getBytesFromBitmap(photo);
...
//                    // we save the file, at least until we have made use of it
                ...
                if (flag == 1) {
                    ...
                    img1 = getBytesFromBitmap(b2);
                    apartment_img1.setImageBitmap(b2);
                } else if (flag == 2) {
                    img2 = getBytesFromBitmap(b2);
                    apartment_img2.setImageBitmap(b2);
                } else {
                    img3 = getBytesFromBitmap(b2);
